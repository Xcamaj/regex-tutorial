...
Regex also known as regular expressions are a sequence of characters that define patterns inside of strings.

## Summary

Regex is a string of text that allows you to create search patterns that match, manage, and locate text. An example code snippet of regex shows as following:
...
Below are the different components of a regular expression explained in detail with examples.
...
Made by Xhemajl Camaj a junior full stack web developer, currently expanding his knowledge on the world of coding. Xhemajl is in the process of finishing his bootcamp with Rutgers University. 

[GitHub Profile](https://github.com/xcamaj)